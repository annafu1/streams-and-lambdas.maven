...
public final class PersonFactory {
    ...
    public List<Person> createPersonList(int listSize) {
        return createPersonStream(listSize).collect(Collectors.toList()); //this is giving structure of a list taking the streams of random people
    }
    ...
    public Person[] createPersonArray(int arrayLength) {
        return createPersonStream(arrayLength).toArray(size -> new Person[arrayLength]); //this is giving structure of array length limited by stream count from the method
    }
    ...
    public Stream<Person> createPersonStream(int streamCount) {
        return Stream.generate(this::createRandomPerson).limit(streamCount); //taking this stream to generate to a random person
    }
}
